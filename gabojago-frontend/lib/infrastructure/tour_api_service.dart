...
class TourApiService {
  static const String _korBase = 'https://apis.data.go.kr/B551011/KorService2';
  ...
  static Uri _buildUri(
    ...
    final common = 'serviceKey=$_key&MobileOS=IOS&MobileApp=가보자GO&_type=json';
  ...
  static Future<Map<String, dynamic>?> getDetailCommon(String contentId) async {
